# Langchain-Chatchat
# https://github.com/chatchat-space/Langchain-Chatchat/blob/61bc81554002241ad38bc268fc7fe79cac380ffb/server/knowledge_base/utils.py#L265
...
from typing import Any, List, Union,Dict, Tuple, Generator

from app.langchain.document_loader.text_splitter import zh_title_enhance as func_zh_title_enhance
...
class KnowledgeFile:
    ...
    def file2docs(self, refresh: bool = False):
        if self.docs is None or refresh:
            logging.info(f"{self.document_loader_name} used for {self.filepath}")
            loader = get_document_loader(loader_name=self.document_loader_name,
    ...
    def docs2texts(
        ...
        if self.ext not in [".csv"]:
            if text_splitter is None:
                text_splitter = get_text_splitter(splitter_name=self.text_splitter_name, chunk_size=chunk_size,
...
# 返回文档加载起
def get_document_loader(loader_name: str, file_path: str, loader_kwargs: Dict = None):
    '''
...
def files2docs_in_thread(
    ...
    for i, file in enumerate(files):
        ...
        try:
            ...
            results.append(False, (kb_name, filename, str(e)))

    results.extend(run_tasks_in_thread_pool(kwargs_list, file2docs))
